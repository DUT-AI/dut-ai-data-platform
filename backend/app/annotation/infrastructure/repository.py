...
def _map_result_to_entity(model: AnnotationResultModel) -> AnnotationResultEntity:
...
class AnnotationRepository(IAnnotationRepository):
    ...
    async def create_revision(
        ...
        # Calculate next revision_number
