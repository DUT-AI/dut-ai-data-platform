...
import { OntologyNodeDetailDialog, type OntologyNodeDetails } from "./ontology-node-detail-dialog";
...
export function OntologyCanvas({
  ...
  const [nodeDetails, setNodeDetails] = useState<OntologyNodeDetails | null>(null);
